            ...
            <div class="sidebar sidebar-collapse" id="sidebar">
                <div class="sidebar__menu-group">
                    <ul class="sidebar_nav">
                        ...
                        <li>
                            <a href="/management/property-configuration" data-inertia-link data-icon-color="#8b5cf6" class="{{ request()->is('management/property-configuration*') || request()->is('construction-types*') || request()->is('categories*') || request()->is('sub-categories*') ? 'active' : '' }}" style="{{ request()->is('management/property-configuration*') || request()->is('construction-types*') || request()->is('categories*') || request()->is('sub-categories*') ? 'background-color: #8b5cf6; color: #ffffff; border-radius: 6px; margin-left: 8px; margin-right: 8px; padding: 8px 12px;' : '' }}">
                                <span data-feather="key" class="nav-icon" style="color: {{ (request()->is('management/property-configuration*') || request()->is('construction-types*') || request()->is('categories*') || request()->is('sub-categories*')) ? '#ffffff' : '#8b5cf6' }};"></span>
                                <span class="menu-text" style="{{ (request()->is('management/property-configuration*') || request()->is('construction-types*') || request()->is('categories*') || request()->is('sub-categories*')) ? 'font-weight: 500; color: #ffffff;' : '' }}">Property Configuration</span>
                            </a>
                        </li>
                    </ul>
                </div>
        ...
        <script>
            ...
            function updateSidebarActiveState() {
                ...
                const routePatterns = {
                    ...
                    '/management/property-configuration': ['/management/property-configuration', '/construction-types', '/categories', '/sub-categories']
                };
