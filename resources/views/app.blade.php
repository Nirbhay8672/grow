...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="apple-touch-icon" href="/img/loader.png">
            ...
            <div class="sidebar sidebar-collapse" id="sidebar">
                <div class="sidebar__menu-group">
                    <ul class="sidebar_nav">
                        ...
                        <li>
                            <a href="/management/property-configuration" data-inertia-link data-icon-color="#8b5cf6" class="{{ request()->is('management/property-configuration*') || request()->is('construction-types*') || request()->is('categories*') || request()->is('sub-categories*') || request()->is('priority-types*') || request()->is('property-sources*') || request()->is('owner-types*') || request()->is('furniture-types*') || request()->is('property-zones*') || request()->is('amenities*') || request()->is('property-construction-documents*') ? 'active' : '' }}" style="{{ request()->is('management/property-configuration*') || request()->is('construction-types*') || request()->is('categories*') || request()->is('sub-categories*') || request()->is('priority-types*') || request()->is('property-sources*') || request()->is('owner-types*') || request()->is('furniture-types*') || request()->is('property-zones*') || request()->is('amenities*') || request()->is('property-construction-documents*') ? 'background-color: #8b5cf6; color: #ffffff; border-radius: 6px; margin-left: 8px; margin-right: 8px; padding: 8px 12px;' : '' }}">
                                <span data-feather="key" class="nav-icon" style="color: {{ (request()->is('management/property-configuration*') || request()->is('construction-types*') || request()->is('categories*') || request()->is('sub-categories*') || request()->is('priority-types*') || request()->is('property-sources*') || request()->is('owner-types*') || request()->is('furniture-types*') || request()->is('property-zones*') || request()->is('amenities*') || request()->is('property-construction-documents*')) ? '#ffffff' : '#8b5cf6' }};"></span>
                                <span class="menu-text" style="{{ (request()->is('management/property-configuration*') || request()->is('construction-types*') || request()->is('categories*') || request()->is('sub-categories*') || request()->is('priority-types*') || request()->is('property-sources*') || request()->is('owner-types*') || request()->is('furniture-types*') || request()->is('property-zones*') || request()->is('amenities*') || request()->is('property-construction-documents*')) ? 'font-weight: 500; color: #ffffff;' : '' }}">Property Configuration</span>
                            </a>
                        </li>
                    </ul>
                </div>
        ...
        <script>
            ...
            function updateSidebarActiveState() {
                ...
                const routePatterns = {
                    ...
                    '/management/property-configuration': ['/management/property-configuration', '/construction-types', '/categories', '/sub-categories', '/priority-types', '/property-sources', '/owner-types', '/furniture-types', '/property-zones', '/amenities', '/property-construction-documents']
                };
