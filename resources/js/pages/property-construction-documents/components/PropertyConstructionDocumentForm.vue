...
interface Props {
    form: any;
    editingPropertyConstructionDocument: PropertyConstructionDocument | null;
...
<template>
    <div>
        <!-- Property Construction Document Name -->
        <div class="form-group mb-2">
            ...
            <input
                ...
                placeholder="Enter property construction document name"
                required
            />
