...
return new class extends Migration
{
    ...
    {
        // Create project_category4_tower_details table
        Schema::create('project_category4_tower_details', function (Blueprint $table) {
            $table->id();
        ...
        // Create project_category4_unit_details table
        Schema::create('project_category4_unit_details', function (Blueprint $table) {
            $table->id();
            $table->foreignId('project_id')->constrained()->onDelete('cascade');
            $table->string('tower_name')->nullable();
        ...
        // Add category4_total_room to projects table
        Schema::table('projects', function (Blueprint $table) {
            $table->string('category4_total_room')->nullable()->after('category3_dynamic_facilities');
        });
    }
    ...
    {
        Schema::dropIfExists('project_category4_unit_details');
        Schema::dropIfExists('project_category4_tower_details');
        
        Schema::table('projects', function (Blueprint $table) {
            $table->dropColumn('category4_total_room');
        });
    }
};
