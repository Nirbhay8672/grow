    ...
    public function run(): void
    {
        $districts = [
            ...
            'Chhattisgarh' => [
                ...
                'Gaurela-Pendra-Marwahi', 'Janjgir-Champa', 'Jashpur', 'Kabeerdham', 'Kanker', 'Kondagaon',
            ...
            'Gujarat' => [
                ...
                'Gandhinagar', 'Gir Som532', 'Jamnagar', 'Junagadh', 'Kachchh', 'Kheda',
            ...
            'Madhya Pradesh' => [
                ...
                'Gwalior', 'Harda', 'Jabalpur', 'Jhabua', 'Katni', 'Khandwa',
            ...
            'Telangana' => [
                'Adilabad', 'Bhadradri Kothagudem', 'Hyderabad', 'Jagitial', 'Jangoan', 'Jayashankar Bhupalpally',
        ...
        foreach ($districts as $stateName => $districtNames) {
            $state = State::where('name', $stateName)->first();
            
            if ($state) {
                foreach ($districtNames as $districtName) {
                    // Check if district already exists to avoid duplicates
                    $existingDistrict = District::where('name', $districtName)
