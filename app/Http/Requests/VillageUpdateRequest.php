        ...
        return [
            'name' => [
                ...
                Rule::unique('villages')->where(function ($query) use ($village) {
                    return $query->where('district_id', $this->district_id ?? $village->district_id)
                        ->where('taluka_id', $this->taluka_id ?? $village->taluka_id);
                })->ignore($village->id),
            ],
            ...
            'taluka_id' => [
                ...
                'required',
                'exists:talukas,id',
                Rule::exists('talukas', 'id')->where(function ($query) use ($village) {
                    return $query->where('district_id', $this->district_id ?? $village->district_id);
                }),
            ],
